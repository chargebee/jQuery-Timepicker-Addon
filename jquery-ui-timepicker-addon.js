        ...
        _newInst: function($input, o) {
            ...
            if(typeof(tp_inst._defaults.controlType) === 'string'){
                if((tp_inst._defaults.controlType == 'slider' && typeof(jQuery.ui.slider) === 'undefined')
                    || (tp_inst._defaults.controlType == 'spinner' && typeof(jQuery.ui.spinner) === 'undefined')){
		...
		*/
        _controls: {
            ...
            spinner: {
                ...
                options: function(tp_inst, obj, unit, opts, val){
                    if(typeof(opts) == 'string' && val !== undefined)
                        return obj.find('.ui-timepicker-spinner').spinner(opts, val);
                    return obj.find('.ui-timepicker-spinner').spinner(opts);
                },
                value: function(tp_inst, obj, unit, val){
                    if(val !== undefined)
                        return obj.find('.ui-timepicker-spinner').spinner('value', val);
                    return obj.find('.ui-timepicker-spinner').spinner('value');
                }
            }
        } // end _controls
